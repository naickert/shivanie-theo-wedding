...
### Header
- Brand monogram: `S & T` (gold ampersand)
...
### Hero
- Eyebrow: `Save the Date — December 2026` *(deliberately no day-range — guests invited to a subset of days shouldn't feel they're missing part)*
...
1. **Day 1 — Thursday · Mehendi** (மருதாணி) · 17 December 2026 · Bride's home, Durban
   > "An intimate day of laughter, song and the slow art of henna being drawn across the bride's hands and feet."
...
### Sections
1. **How We Met** — *awaiting the couple's words; the live site shows a graceful "coming soon" note.* Short, warm paragraph: first time their paths crossed, where, what year, the small ordinary moment they both remember.
2. **The Proposal** — *awaiting the couple's words; the live site shows a graceful "coming soon" note.* Proposal story in the couple's voice: where, when, who knew, who was hiding, what Shivanie was wearing.
...
### Page header
- Eyebrow: `Two Families, One Celebration` *(deliberately no day-count — guests invited to a subset of days shouldn't feel left out)*
...
- Run of show: 17:00 arrivals, 18:00 *nalangu* games (coconut rolling, turmeric ring hunt, teasing rituals), 20:00 dinner, 21:30 *sangeeth* performances by family, dance floor till late (01:00 soft close).
- Practical: on-site + street parking; bar arrangements TBC with Kendra Hall; vegetarian food; lift to main hall.
...
- Run of show: 14:00 arrivals, 14:30 seated, 15:00 ceremony begins, 15:15 *muhurtham* (thaali tying), 16:00 ceremony concludes & cocktails, 17:30 reception entrance (indoor), 18:00 cake cutting & MC welcome, 18:30 dinner, 19:30 special performances, 20:00 open dance floor, 23:00 send-off. **No formal speeches, no first dance** (couple's explicit preference — see master plan).
- Practical: ample on-site parking with guided arrival lane; single-level indoor reception; vegetarian feast; bar at the reception.
...
3. **Glossary** — alphabetical list of terms guests will hear:
   ...
   - *Thaali* — the sacred necklace tied around the bride's neck (the moment that legally and ritually marries the couple in Tamil tradition).
...
7. **Gifts** — see `#/registry`. Cards and envelopes are warmly received; please no fresh flowers (the families will have plenty).
...
7. **Is there an open bar?** Bar at the Saturday reception; Friday bar arrangements TBC with Kendra Hall. Soft bar only on Thursday.
8. **Can I take photos?** Yes — from your seat; just keep the *mandap* and the photographer's sightlines clear during the ceremony. Tag posts with **#ShivanieAndTheo2026**.
9. **Where do I send a gift?** See the registry page. Cards and envelopes are warmly received; please no fresh flowers.
...
12. **What's the deadline to RSVP?** **Saturday 31 October 2026.**
...
- Cards and envelopes warmly received; honeymoon fund as the single optional gift target.
...
- Title: `RSVP`
- Sub-line: `We need your reply by Saturday 31 October 2026.`
